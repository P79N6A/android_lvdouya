package com.hhkj.dyedu.view.scrawldemo.config;
...
public class AnnotationConfig {
    ...
    @IntDef({PaintType.Paint_Red, PaintType.Paint_Orange, PaintType.Paint_White,PaintType.Paint_Yellow, PaintType.Paint_Green, PaintType.Paint_Blue, PaintType.Paint_Purple, PaintType.Paint_Eraser})
    public @interface PaintType{
        ...
        public static final int Paint_White = 8;
