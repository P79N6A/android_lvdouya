 ...
 * 日期选择器
 */
public class ClassTmePickerDialog extends Dialog {
    //设置最小年份
    private static final int MIN_YEAR = 1870;
    private Params params;

    public ClassTmePickerDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public ClassTmePickerDialog create() {
            final ClassTmePickerDialog dialog = new ClassTmePickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
